...
#define REPEATED_START_EN	1
#define REPEATED_START_DI	0
...
__attribute__((weak)) void DAL_I2C_EV_ApplicationEventCallback(I2C_Handle_t* , uint8_t EV_Name);
__attribute__((weak)) void DAL_I2C_ER_ApplicationEventCallback(I2C_Handle_t* , uint8_t ER_Name);
